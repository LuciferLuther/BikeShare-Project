# A Data Exploration with pandas on Bikeshare Data
...
You can input 'bikeshare_2.py' on your terminal to run this program. I use Anaconda's command prompt on a Windows 11 machine.
